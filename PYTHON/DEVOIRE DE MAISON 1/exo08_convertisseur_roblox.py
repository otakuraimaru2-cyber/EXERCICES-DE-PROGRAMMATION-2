...
prix_skin_robux = int(input("Combien coûte le skin de tes rêves en robux ? "))

robux_max = int(budget_euros * TAUX_CONVERSION)

cout_reel_euros = prix_skin_robux / TAUX_CONVERSION
...
print(f"• Avec {budget_euros:.2f} €, tu obtiens : {robux_max} VBucks.")
